...
//
// ЗЕРКАЛЬНОЙ ФУНКЦИИ «РОДИТЕЛЯ ВЕРНУЛИ — ВЕРНУТЬ ДЕТЕЙ» НЕТ, И ЭТО РЕШЕНИЕ
// ВЛАДЕЛЬЦА 11.09, А НЕ НЕДОДЕЛКА. Дети остаются под вопросом, зовущий
// возвращает каждого сам. Довод: автоматический возврат был бы зеркальным
// «отменить за людей», а ровно этим доводом 08.09 отвергнута отмена детей
// вместе с родителем. Строка стоит здесь потому, что отсутствие функции
// ничем другим не заметно: следующий увидит односторонний триггер и примет
// его за половину работы (I64). Разбор — `docs/plan.md`, решение 6.
