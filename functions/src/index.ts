...
// её и не достаёт.
//
// Лимиты не «на глазок», а от замера по проду (02.08, 805 документов,
// 76 объектов): обход ссылок 17 с, листинг Storage 1 с. При бюджете
// 480 с это запас примерно в 28 раз по числу документов — и он назван
// числом именно потому, что первая оценка «единицы секунд, запас в
// сотни раз» оказалась неверной: обход тогда занимал 90 с.
//
