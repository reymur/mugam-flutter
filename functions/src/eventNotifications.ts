...
export type EventActionType =
  ...
  // полю, и незнакомое имя проваливается в умолчание. **Для `ownerCancelled`
  // это означает молчание на отмене личного вечера — записано находкой
  // N213 и здесь НЕ чинится:** это поведение уведомлений, а шаг 8 везёт одну
  // переменную (I48).
  //
  ...
  //                    личного вечера с 13.08);
  //   ownerRestored  — и вернул его же;
  //   ownerFirm      — «всё точно», плашка состояния;
  //   ownerDoubt     — «под вопросом», она же;
  //   restored       — выход наверх из «под вопроса» (клиент пишет с 09.09).
  | "ownerCancelled"
  | "ownerRestored"
  | "ownerFirm"
  | "ownerDoubt"
