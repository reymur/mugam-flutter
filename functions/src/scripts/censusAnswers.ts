...
//
//   ИЗБЫТОК (ключ вне состава) — ОЖИДАЕМ. Правило leavesEvent() разрешало
//   трогать только `musicians`, и ключ ушедшего в карте оставался. Правило
//   снято 30.08 (N121, шаг 3), НО ЗАПИСИ ОСТАЛИСЬ: новых таких ключей
//   участник больше не наделает, старые в проде лежат и будут считаться.
//
