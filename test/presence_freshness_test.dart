...
void main() {
  ...
  // isActuallyOnline обслуживает зелёную точку в 12 ФАЙЛАХ и «● Onlayn»
  // (счёт снят 18.09: `grep -rn "isActuallyOnline" lib`, без `models.dart` и
  // комментариев, по файлам — двенадцать; прежнее «13 экранах» было названо
  // без команды рядом и разошлось, как только к списку прибавился лист
  // выбора людей — I6: у числа стоит либо дата, либо команда).
